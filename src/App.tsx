...
import { Shield, Crosshair, Navigation, AlertTriangle, Info, Ship, Anchor, HelpCircle } from 'lucide-react';
...
export default function App() {
  ...
  const [stats, setStats] = useState<SimulationStats>({ friendly: 0, enemy: 0, fishing: 0, unknown: 0 });
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-300 font-sans p-4 flex flex-col">
      ...
      <div className="flex-1 grid grid-cols-1 lg:grid-cols-12 gap-4 lg:h-[600px]">
        {/* Left Panel: Logs */}
        <div className="lg:col-span-3 flex flex-col bg-slate-900 rounded-xl border border-slate-800 overflow-hidden h-[600px]">
        ...
        {/* Center: Map */}
        <div className="lg:col-span-7 flex flex-col items-center justify-center bg-slate-900 rounded-xl border border-slate-800 p-2 h-[600px]">
          ...
          <div className="bg-slate-900 rounded-xl border border-slate-800 p-4 flex-1">
            ...
            <div className="space-y-4 text-sm">
              ...
              <div className="flex items-center gap-3 pt-2 border-t border-slate-800">
                ...
                <span className="text-xs text-slate-400">2km 偵測範圍</span>
              </div>
            </div>
          </div>
        </div>
